...
<textarea id="gotermslist" rows="5"><?php echo file_get_contents( "goterm.example.genes" );?></textarea><br><span style="color: blue; cursor: pointer" onclick="loadTextArea()">sample text</span>
<br><br>
