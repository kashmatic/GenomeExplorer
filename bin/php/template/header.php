...
<header class="header">
	<a href="/index.php" class="logo">GenomeExplorer</a>
...
<li class="dropdown notifications-menu">
  ...
  <ul class="dropdown-menu">
    ...
    <ul class="menu">
    	<li>
    		<a href="/info/about.php"><i class="ion ion-ios7-people info"></i> About </a>
    	</li>
    	<li>
    		<a href="/info/info.php"><i class="fa fa-info success"></i> Info </a>
    	</li>
	    <li>
	    	<a href="/info/team.php"><i class="fa fa-users warning"></i> Team </a>
  	  </li>
  	  <li>
	    	<a href="/info/links.php"><i class="fa fa-external-link info"></i> Links </a>
  	  </li>
		</ul>
		</li>
	</ul>
